...
function addCard(){
	...
	cardBtnBefore.addEventListener("click", function addBefore(e) {
  	...
  	cardBtnAfter.addEventListener("click", function addAfter(e) {
  	...
  	cardBtnDelete.addEventListener("click", function del(e) {
  		let cardTgt = e.target.parentElement;
